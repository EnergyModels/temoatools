...
# run
cd tools
python generate_scenario_tree_JB.py options/stoch_V_0.py --debug
python rewrite_tree_nodes.py options/stoch_V_0.py --debug
cd ..
python temoa_model/temoa_stochastic.py --config=temoa_model/config_stoch_V_0.txt
