...
# Version 2
#============================
order = ["LCOE (cents/kWh)", "2052 COE (10 cents/kWh)","Avg. Emissions (Gton/yr)","2052 Emissions (Gton/yr)","Build-back time (100 days)","Initial Population w/o Power (million people)"]
