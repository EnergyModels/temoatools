...
# User Inputs
#=====================================================
figure_name = "presentationFigure_MC_yearly_activity" # png extension automatically added later
...
all_y_labels = [["Coal (TWh/yr)","Petroleum (TWh/yr)","Natural Gas (TWh/yr)"],["Solar (TWh/yr)","Wind (TWh/yr)","Battery (TWh/yr)"]]
versions = ['a','b']
...
for y_vars, y_labels, version in zip(all_y_vars,all_y_labels,versions):
    ...
    # Create Plots
    f, ax = plt.subplots(nrows, ncols, figsize=[12,5])
    ...
    leg = ax[0].legend(bbox_to_anchor=(2.0, -0.2), loc='center', ncol=len(series_labels)/2, frameon = False, scatterpoints = 1)
