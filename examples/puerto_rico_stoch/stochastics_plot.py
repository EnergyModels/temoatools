...
folders = ['2019_09_25_HAZUS_moderate', 'Results\\2019_09_27_HAZUS_severe']
...
db_dict = {"A": 'Centralized - Natural Gas', "B": 'Centralized - Hybrid', "C": 'Distributed - Natural Gas',
           "D": 'Distributed - Hybrid', "s": "Baseline"}
...
for folder in folders:
    ...
    if plotActivity:
        ...
        # Box Plot
        g = sns.catplot(x="Year", y="Value", hue="Scenario", col="Type", data=df2, kind="box", col_wrap=3,
        ...
        # Violin Plot
        g = sns.catplot(x="Year", y="Value", hue="Scenario", col="Type", data=df2, kind="violin", col_wrap=3,
                        col_order=col_order, palette=custom_palette)  # ,height=4, aspect=.7)
        savename = figure_name + "_violin_" + context + '.pdf'
        plt.savefig(savename, dpi=resolution, bbox_inches="tight")
        plt.close()
