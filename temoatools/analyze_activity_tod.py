# -*- coding: utf-8 -*-
"""
Created on Mon Dec 10 14:41:46 2018
...
def name(db):
    return db[:db.find('.')]
#==============================================================================
def getActivityTOD(folders,dbs,switch='fuel',sectorName='electric',saveData='N',createPlots='N',conversion=277.777778):
#    inputs:
...
#==============================================================================
    ...
    for folder,db in zip(folders,dbs):
        activity[name(db)] = SingleDB(folder,db,switch=switch,sectorName=sectorName,saveData=saveData,createPlots=createPlots,conversion=conversion)
